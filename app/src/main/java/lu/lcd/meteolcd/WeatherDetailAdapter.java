...
public class WeatherDetailAdapter extends ArrayAdapter<WeatherDetail> {
    ...
    public WeatherDetailAdapter(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public WeatherDetailAdapter(Context context, int resource, List<WeatherDetail> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.detail_list_item, null);
        }

        WeatherDetail p = getItem(position);
